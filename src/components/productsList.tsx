...
//                 <img className="h-80 w-full object-cover bg-gray-200" src={product.image} alt={product.name} />
//                 <div className="p-4">
//                   <h3 className="text-lg font-semibold text-gray-800">{product.name}</h3>
//                   <p className="text-gray-600">${product.price}</p>
//                   <div className="mt-4">
//                     <Link className="block text-center bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition" to={`/single-product/${product.id}`}>
//                       View Product
//                     </Link>
//                   </div>
//                 </div>
